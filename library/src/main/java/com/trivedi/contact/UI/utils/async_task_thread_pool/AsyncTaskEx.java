 ...
 */
package com.trivedi.contact.UI.utils.async_task_thread_pool;
...
public abstract class AsyncTaskEx<Params,Progress,Result>
   ...
   * reference to it.
   * <p>
   * This method is typically used with {@link #THREAD_POOL_EXECUTOR} to allow multiple tasks to run in parallel on a pool of threads managed by CustomAsyncTask, however you can also use your own {@link Executor} for custom behavior.
   * <p>
